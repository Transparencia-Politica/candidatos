...
| [`16-scoring-improvements-tracker.md`](research/16-scoring-improvements-tracker.md) | Tracker for the next iteration of the current wealth-tax score: use `weight`, separate core/context laws, add confidence, and show asset exposure as context. |
| [`17-wealth-tax-signature-vote-package.md`](research/17-wealth-tax-signature-vote-package.md) | Curated wealth-tax signature-vote package: which laws count, why they count, which ones are context, and how to maintain the package. |
